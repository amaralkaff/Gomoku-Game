...
const initialState = {
    ...
    waiting: true, // waiting for p2 to join
};
    ...
    reducers: {
        onSquareClick: (state, action) => {
            ...
            set(ref(database, "gomokuGame"), {
                p1: { join: true, lastMove: state.lastMoveByX },
                p2: { join: true, lastMove: state.lastMoveByO },
                gameId: 1,
...
export const { onSquareClick, updateGameState, reset, setWaiting } = gomokuSlice.actions;
